...
const SignIn: React.FC = () => {
  ...
  return (
    <div className="rounded-sm border flex justify-center border-stroke bg-white shadow-default h-screen dark:border-strokedark dark:bg-boxdark">
