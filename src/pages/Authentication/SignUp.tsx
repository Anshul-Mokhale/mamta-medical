...
const SignUp: React.FC = () => {
  ...
  return (
    ...
    <div className="rounded-sm border flex justify-center h-full md:h-full xl:h-full border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center w-full">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-9 px-9 text-center">
            ...
            <span className="mt-9 inline-block">
              <svg
                width="350"
                height="350"
                viewBox="0 0 350 350"
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-9">
            <span className="mb-1.5 block font-medium xl:hidden"><Link to='/'><FontAwesomeIcon icon={faArrowLeft} /> &nbsp; Home</Link></span>

            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
              Sign Up to Mamta Medical
            </h2>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      // Use a regular expression to replace non-digit characters and limit the length to 10
                      const formattedPhone = inputPhone.replace(/\D/g, '').slice(0, 10);
                      // Set the phone state with the formatted phone number
