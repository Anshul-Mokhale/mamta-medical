...
import orderimage from "../../images/ordernow.svg";
  ...
  return (
    <DefaultLayout>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-2 2xl:gap-7.5">
        <CardDataStats title="Total Orders" total="10" rate="">
          <FontAwesomeIcon icon={faCartShopping} className='text-primary text-2xl' />
        </CardDataStats>
        <CardDataStats title="Total Payments" total="10" rate="">
