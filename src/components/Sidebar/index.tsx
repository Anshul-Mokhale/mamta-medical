...
import Logo from '../../website/assets/logo/logo-no-background.png';
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M21 4H3C1.9 4 1 4.9 1 6v12c0 1.1 0.9 2 2 2h18c1.1 0 2-0.9 2-2V6c0-1.1-0.9-2-2-2zm0 14H3V10h18v8zm0-12H3V6h18v2z"
                      fill="currentColor"
                    />
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M12 1C6.48 1 2 5.48 2 11v6c0 1.66 1.34 3 3 3h2c.55 0 1-.45 1-1v-5c0-.55-.45-1-1-1H5v-2c0-3.86 3.14-7 7-7s7 3.14 7 7v2h-3c-.55 0-1 .45-1 1v5c0 .55.45 1 1 1h2c1.66 0 3-1.34 3-3v-6c0-5.52-4.48-10-10-10z"
                      fill="currentColor"
                    />
                  </svg>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment >
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/user/account-settings' || pathname.includes('account-settings')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/user/account-settings/update-account"
                              className={({ isActive }) =>
