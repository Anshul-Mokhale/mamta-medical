...
import { faBoxOpen, faFileInvoice, faHeadset, faWallet } from '@fortawesome/free-solid-svg-icons';
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/user/bills"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('bills') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment >
                      <NavLink
                        to="#"
                        className={`group hidden relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/ui' || pathname.includes('ui')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
